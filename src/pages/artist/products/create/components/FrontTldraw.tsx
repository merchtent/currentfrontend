...
const FrontTldraw: React.FC<FrontProps> = ({ selectedProduct, frontImage }) => {
    ...
    return (
        <Box>
            <input
                ...
                onChange={handleFileChangeFront} // Handles file change
            ...
            <div style={{ position: 'relative', width: '900px', height: '900px', zIndex: '1', background: 'white' }}>
                ...
                <div style={{
                    position: 'absolute',
                    top: selectedProduct.supplierProductBounds?.find(bound => bound.type === 'front')?.top, // Position from the top 50%
                    left: selectedProduct.supplierProductBounds?.find(bound => bound.type === 'front')?.left, // Position from the left 50%
                    width: selectedProduct.supplierProductBounds?.find(bound => bound.type === 'front')?.width, // Width of the square
                    height: selectedProduct.supplierProductBounds?.find(bound => bound.type === 'front')?.height, // Height of the square
